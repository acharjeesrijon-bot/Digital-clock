...
public class DigitalClock{
    ...
    private static final DateTimeFormatter alarmTimeFormat = DateTimeFormatter.ofPattern("HH:mm:ss");
    ...
    public void main(String[] args) {
        ...
        JTextField alarmReasonField = new JTextField(10);
        ...
        addAlarmButton.addActionListener(e -> {
            ...
            try {
                LocalTime alarmTime = LocalTime.parse(timeText, alarmTimeFormat);
